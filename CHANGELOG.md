...
- **openrouter** (updated 3): `deepseek/deepseek-v4-flash`, `tencent/hy3`, `z-ai/glm-5.2`
- **zai** (updated 1): `glm-5.3-flash`
...
## 26.96.38 — 2026-09-09T06:52Z (content update)

- price sync (1 change):
- **openrouter** (updated 1): `qwen/qwen3-235b-a22b-2507`
...
- **openrouter** (updated 8): `deepseek/deepseek-v4-flash`, `deepseek/deepseek-v4-pro`, `ibm-granite/granite-4.2-8b`, `minimax/minimax-m1`, `moonshotai/kimi-k2-thinking`, `qwen/qwen3-next-80b-a3b-instruct`, `tencent/hy3`, `z-ai/glm-4.6`
...
- price sync (1 change):
- **openrouter** (updated 1): `deepseek/deepseek-v4-flash-0731`

## 26.89.37 — 2026-09-08T03:50Z (content update)

- price sync (4 changes):
- **openrouter** (updated 4): `deepseek/deepseek-v4-flash-vision-exp`, `deepseek/deepseek-v4-pro-0813`, `minimax/minimax-m1`, `qwen/qwen3-14b`
...
- **openrouter** (updated 6): `deepseek/deepseek-v4-flash`, `deepseek/deepseek-v4-flash-vision-exp`, `deepseek/deepseek-v4-pro`, `deepseek/deepseek-v4-pro-0813`, `~deepseek/deepseek-v4-flash-latest`, `~z-ai/glm-flash-latest`
...
- price sync (6 changes):
- **openrouter** (updated 6): `deepseek/deepseek-v4-flash`, `deepseek/deepseek-v4-flash-0731`, `deepseek/deepseek-v4-pro`, `tencent/hy3`, `z-ai/glm-4.6`, `z-ai/glm-5.3`

## 26.81.34 — 2026-09-06T21:53Z (content update)

- price sync (4 changes):
- **openrouter** (updated 4): `deepseek/deepseek-v4-flash`, `deepseek/deepseek-v4-pro`, `qwen/qwen3.5-397b-a17b`, `tencent/hy3`

## 26.80.34 — 2026-09-06T15:49Z (content update)

- price sync (4 changes):
- **openrouter** (-1): `z-ai/glm-5.2:free`
- **openrouter** (updated 3): `deepseek/deepseek-v4-flash`, `deepseek/deepseek-v4-pro`, `deepseek/deepseek-v4-pro-0813`

## 26.79.34 — 2026-09-06T12:50Z (content update)

- price sync (2 changes):
- **openrouter** (updated 2): `deepseek/deepseek-v4-flash`, `deepseek/deepseek-v4-pro`

## 26.78.34 — 2026-09-06T09:45Z (content update)

- price sync (4 changes):
- **openrouter** (updated 4): `deepseek/deepseek-v4-flash`, `deepseek/deepseek-v4-flash-0731`, `deepseek/deepseek-v4-pro`, `~deepseek/deepseek-v4-flash-latest`

## 26.77.34 — 2026-09-06T06:45Z (content update)

- price sync (3 changes):
- **openrouter** (updated 3): `deepseek/deepseek-v4-flash`, `deepseek/deepseek-v4-pro`, `z-ai/glm-4.6`

## 26.76.34 — 2026-09-06T03:44Z (content update)

- price sync (3 changes):
- **openrouter** (updated 3): `deepseek/deepseek-v4-flash`, `deepseek/deepseek-v4-pro`, `deepseek/deepseek-v4-pro-0813`

## 26.75.34 — 2026-09-06T00:48Z (content update)

- price sync (5 changes):
- **openrouter** (updated 5): `deepseek/deepseek-v4-flash`, `deepseek/deepseek-v4-pro`, `tencent/hy3`, `z-ai/glm-4.6`, `~z-ai/glm-latest`

## 26.74.34 — 2026-09-05T21:46Z (content update)

- price sync (2 changes):
- **openrouter** (updated 2): `deepseek/deepseek-v4-flash`, `deepseek/deepseek-v4-pro`

## 26.73.34 — 2026-09-05T18:46Z (content update)

- price sync (4 changes):
- **openrouter** (updated 4): `deepseek/deepseek-v4-flash`, `deepseek/deepseek-v4-pro`, `qwen/qwen3.5-35b-a3b`, `tencent/hy3`

## 26.72.34 — 2026-09-05T15:45Z (content update)

- price sync (3 changes):
- **openrouter** (updated 3): `deepseek/deepseek-v4-flash`, `deepseek/deepseek-v4-pro`, `deepseek/deepseek-v4-pro-0813`

## 26.71.34 — 2026-09-05T12:45Z (content update)
...
- price sync (4 changes):
- **openrouter** (+1): `qwen/qwen3.8-max-0902`
- **openrouter** (-1): `qwen/qwen3.8-max`
- **openrouter** (updated 2): `deepseek/deepseek-v4-flash`, `deepseek/deepseek-v4-pro`
