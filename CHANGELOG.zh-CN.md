...
## 26.147.98 — 2026-09-14T12:45Z（内容更新）

- 数据(alibaba)：补种 56 个官方 Model Studio 国际站模型（tier0_alibaba 解析结果；未公布的规格留空）
...
## 26.141.93 — 2026-09-14T01:01Z（内容更新）

- 价格同步（8 处变更）：
- **openrouter**（更新 8）：`deepseek/deepseek-v4-flash`, `deepseek/deepseek-v4-flash-0731`, `deepseek/deepseek-v4-pro-0813`, `nvidia/nemotron-3-ultra-550b-a55b`, `qwen/qwen3-14b`, `tencent/hy3`, `z-ai/glm-5.2`, `z-ai/glm-5.3`

## 26.140.93 — 2026-09-13T23:11Z（功能更新）

- 修复 category 分类：补全 asr、text-to-audio、连字符可选 diffusion、nano-banana、fish-audio 标记，重分类 13 行

## 26.140.92 — 2026-09-13T21:59Z（内容更新）
...
## 26.137.88 — 2026-09-13T14:58Z（功能更新）

- 修复 stepfun 校验（补上 stepaudio-* 系列正则）+ 补种 6 个缺失的官方在售模型

## 26.137.87 — 2026-09-13T13:00Z（内容更新）

- 价格同步（1 处变更）：
- **openrouter**（更新 1）：`deepseek/deepseek-v4-flash`

## 26.136.87 — 2026-09-13T11:42Z（功能更新）

- 修复脚本重构后文档中失效的 scripts/*.py 路径，并新增 audit 检查 #6b

## 26.136.86 — 2026-09-13T09:59Z（内容更新）
...
## 26.132.84 — 2026-09-13T01:00Z（内容更新）

- 价格同步（21 处变更，另有 2 项校验记录）：
- **openrouter**（更新 21）：`deepseek/deepseek-v4-pro-0813`, `google/gemini-2.5-flash-image`, `google/gemini-3-pro-image`, `google/gemini-3-pro-image-preview`, `google/gemini-3.1-flash-image`, `google/gemini-3.1-flash-image-preview`, `google/gemini-3.1-flash-lite-image`, `google/gemma-4-26b-a4b-it`, `google/lyria-3-clip-preview`, `google/lyria-3-pro-preview`, `meta/muse-glimmer-30b`, `moonshotai/kimi-k2-thinking`, `openai/gpt-5-image`, `openai/gpt-5-image-mini`, `openai/gpt-5.4-image-2`, `openai/gpt-audio`, `openai/gpt-audio-mini`, `openrouter/auto`, `openrouter/auto-beta`, `tencent/hy3`, `z-ai/glm-5.3`
- **requesty**（校验跳过 2）：`thinkingcap-qwen3.6-27b`, `thinkingcap-qwen3.6-27b@eu`
...
## 26.128.76 — 2026-09-12T13:17Z（功能更新）

- docs(agents)：明确同步日志/标题按去重后模型数计数的规则

## 26.128.75 — 2026-09-12T13:15Z（功能更新）

- 修复：同步日志按去重后的模型数计数（item_id 去重、标题计数）
...
- 价格同步（4 处变更）：
- **openrouter**（更新 4）：`deepseek/deepseek-v4-flash`, `deepseek/deepseek-v4-flash-0731`, `deepseek/deepseek-v4-pro`, `~deepseek/deepseek-v4-flash-latest`
...
## 26.123.72 — 2026-09-12T01:59Z（功能更新）

- 修复(同步摘要): 校验类(surge_skip)记录不再被误报为价格更新
...
## 26.122.70 — 2026-09-11T22:26Z（功能更新）

- 修复(toolbox)：将 >5x 突变保护拒绝的写入记录为 changelog 条目，并新增 audit 检查 #9 检测未解决的跳过（静默跳过类）

## 26.122.69 — 2026-09-11T22:23Z（内容更新）

- 手动修正 cortecs `qwen3.8-27b` 输出价（$2.451 → $0.4，依据 models.dev；原值被同步 >5x 突变保护静默跳过）
...
## 26.118.66 — 2026-09-11T14:17Z（内容更新）

- data: 补齐两家官方在售但库中缺失的模型（MiniMax-M2.1-highspeed、ministral-14b-latest）

## 26.117.66 — 2026-09-11T14:14Z（功能更新）

- fix(deepseek): 将 tier0 检查指向线上模型 id deepseek-flash；新增模型 id 对齐守卫

## 26.117.65 — 2026-09-11T12:59Z（内容更新）

- 价格同步（10 处变更）：
- **deepinfra**（更新 1）：`XiaomiMiMo/MiMo-V2.5`
...
- **kilo**（更新 5）：`nvidia/nemotron-3-super-120b-a12b`, `~moonshotai/kimi-latest`, `deepseek/deepseek-chat-v3-0324`, `~z-ai/glm-latest`, `tencent/hy3`
- **llmgateway**（更新 1）：`gemma-4-31b-it`
- **nano-gpt**（更新 7）：`alibaba/qwen3.8-flash`, `sakana/fugu-ultra`, `sakana/fugu-ultra-v1.1`, `deepseek/deepseek-v4-flash-vision-exp`, `deepseek/deepseek-v4-flash-0731`, `deepseek/deepseek-v4-flash-latest`, `deepseek/deepseek-v4-flash-0731:thinking`
- **ofox**（更新 5）：`google/gemini-2.5-flash-lite`, `deepseek/deepseek-v4-pro-0423`, `z-ai/glm-4.7`, `z-ai/glm-4.6`, `z-ai/glm-4.7-flashx`
- **openrouter**（更新 2）：`deepseek/deepseek-v4.1-flash`, `meta-llama/llama-3.1-70b-instruct`
- **vercel**（更新 1）：`deepseek/deepseek-v3.2`

## 26.116.65 — 2026-09-11T12:00Z（功能更新）

- 修复 deepseek-v4-pro 过时备注：官方已撤回下线计划，2026-09-14 后继续提供 V4 Pro 服务且计费不变
...
## 26.113.60 — 2026-09-11T01:21Z（功能更新）

- 修复 models.dev 聚合源覆盖一方官方源数据：一方守卫改为与时间戳无关（有专属采集器的供应商永不写入）+ 26 小时新鲜度窗口，杜绝跨 UTC 午夜后回退覆盖（deepseek/zhipuai 事件）

## 26.113.59 — 2026-09-11T00:12Z（功能更新）

- 文档(agents)：记录写入器的来源备注不变量（核验即写入，而非仅在价格变动时）

## 26.113.58 — 2026-09-11T00:10Z（功能更新）

- 修复写入器：价格未变时也持久化检查脚本的来源备注（回填 opencode/opencode-go 共 71 个无来源模型）；audit 对任何无备注的付费模型告警

## 26.113.57 — 2026-09-10T21:51Z（内容更新）

- 价格同步（1 处变更）：
- **openrouter**（更新 1）：`deepseek/deepseek-v4-flash`

## 26.112.57 — 2026-09-10T21:30Z（功能更新）

- 测试(zhipuai)：断言价目表缓存命中价写入 per_mtok

## 26.112.56 — 2026-09-10T21:28Z（功能更新）

- 修复(zhipuai检查)：按 bigmodel.cn 价目表补写缓存命中 CNY 价

## 26.112.55 — 2026-09-10T20:24Z（功能更新）

- 修复(检查): 解析 OpenCode Zen/Go 官方价目表——将仅探测的占位检查改为真正的解析器，使厂商官方价目表（而非 models.dev 聚合源）成为权威来源；修正 deepseek-v4-pro 输出 3.84->3.48、kimi-k2.5 缓存读 0.08->0.10、claude-fable-5-1 缓存写 null->12.5（另 6 项）

## 26.112.54 — 2026-09-10T19:14Z（内容更新）

- 修复 zhipuai glm-5.3-flash 的 USD 价：更新为 z.ai 现行 $0.15/$0.50/$0.03（原 0.075/0.25/0.015 系已过期的五折促销价）

## 26.111.54 — 2026-09-10T19:09Z（功能更新）

- 修复 zhipuai 采集/检查：改为抓取 bigmodel.cn「API 定价」费率卡（旧 JS 页改版后解析器匹配 0 行、检查长期报红）；GLM-4.7-Flash 官方免费，GLM-5.3-Flash 国内价为 ¥0.8/¥2.8
...
## 26.109.50 — 2026-09-10T13:08Z（内容更新）

- openrouter 聚合源同步（4 处价格更新）+ 清除 #173 之前差分逻辑产生的 436 条虚假 status 变更记录

## 26.109.49 — 2026-09-10T12:57Z（内容更新）

- 价格同步：**openrouter** — 4 处价格更新：`deepseek/deepseek-v4.1-flash`（$0.30/$1.20/$0.006 → $0.15/$0.60/$0.003）、`qwen/qwen3-30b-a3b-instruct-2507`（$0.09/$0.30 → $0.04815/$0.19305）、`z-ai/glm-5.3-flash`（$0.075/$0.25/$0.015 → $0.15/$0.50/$0.03）、`~z-ai/glm-latest`（输入 $1.085 → $1.0075）
...
## 26.102.38 — 2026-09-09T21:56Z（内容更新）

- 价格同步（1 处变更）：
- **tencent**（更新 1）：`hunyuan-hy3`

## 26.101.38 — 2026-09-09T21:04Z（内容更新）

- 修复 tencent hunyuan-hy3 编造的 usd 价（仅 CNY 定价、无官方 USD）置 null；audit 增加 usd==cny 硬门禁
...
## 26.96.38 — 2026-09-09T06:52Z（内容更新）

- 价格同步（1 处变更）：
- **openrouter**（更新 1）：`qwen/qwen3-235b-a22b-2507`

## 26.95.38 — 2026-09-09T03:52Z（内容更新）

- 价格同步（2 处变更）：
- **openrouter**（更新 2）：`deepseek/deepseek-v4-pro-0813`, `~moonshotai/kimi-latest`
...
- 价格同步（1 处变更）：
- **openrouter**（更新 1）：`deepseek/deepseek-v4-flash-0731`

## 26.89.37 — 2026-09-08T03:50Z（内容更新）

- 价格同步（4 处变更）：
- **openrouter**（更新 4）：`deepseek/deepseek-v4-flash-vision-exp`, `deepseek/deepseek-v4-pro-0813`, `minimax/minimax-m1`, `qwen/qwen3-14b`
...
- **openrouter**（context_window）：`mistralai/mistral-medium-3-5:batch` 32768→262144
...
- 价格同步（6 处变更）：
- **openrouter**（更新 6）：`deepseek/deepseek-v4-flash`, `deepseek/deepseek-v4-flash-vision-exp`, `deepseek/deepseek-v4-pro`, `deepseek/deepseek-v4-pro-0813`, `~deepseek/deepseek-v4-flash-latest`, `~z-ai/glm-flash-latest`

## 26.82.36 — 2026-09-07T04:15Z（功能更新）

- 重构脚本层：按职责归组为 sync/migrate/tools 子包

## 26.82.35 — 2026-09-07T03:47Z（功能更新）

- 修复 README '当前规模' 散文行与数据不同步：该行位于 STATS 标记外、此前无校验覆盖；现由 stats.py 自动重生成，validate.py 校验其与数据集一致

## 26.82.34 — 2026-09-07T00:51Z（内容更新）

- 价格同步（6 处变更）：
- **openrouter**（更新 6）：`deepseek/deepseek-v4-flash`, `deepseek/deepseek-v4-flash-0731`, `deepseek/deepseek-v4-pro`, `tencent/hy3`, `z-ai/glm-4.6`, `z-ai/glm-5.3`
...
- 价格同步（4 处变更）：
- **openrouter**（下架 1）：`z-ai/glm-5.2:free`
- **openrouter**（更新 3）：`deepseek/deepseek-v4-flash`, `deepseek/deepseek-v4-pro`, `deepseek/deepseek-v4-pro-0813`

## 26.79.34 — 2026-09-06T12:50Z（内容更新）

- 价格同步（2 处变更）：
- **openrouter**（更新 2）：`deepseek/deepseek-v4-flash`, `deepseek/deepseek-v4-pro`

## 26.78.34 — 2026-09-06T09:45Z（内容更新）

- 价格同步（4 处变更）：
- **openrouter**（更新 4）：`deepseek/deepseek-v4-flash`, `deepseek/deepseek-v4-flash-0731`, `deepseek/deepseek-v4-pro`, `~deepseek/deepseek-v4-flash-latest`

## 26.77.34 — 2026-09-06T06:45Z（内容更新）

- 价格同步（3 处变更）：
- **openrouter**（更新 3）：`deepseek/deepseek-v4-flash`, `deepseek/deepseek-v4-pro`, `z-ai/glm-4.6`

## 26.76.34 — 2026-09-06T03:44Z（内容更新）

- 价格同步（3 处变更）：
- **openrouter**（更新 3）：`deepseek/deepseek-v4-flash`, `deepseek/deepseek-v4-pro`, `deepseek/deepseek-v4-pro-0813`

## 26.75.34 — 2026-09-06T00:48Z（内容更新）

- 价格同步（5 处变更）：
- **openrouter**（更新 5）：`deepseek/deepseek-v4-flash`, `deepseek/deepseek-v4-pro`, `tencent/hy3`, `z-ai/glm-4.6`, `~z-ai/glm-latest`

## 26.74.34 — 2026-09-05T21:46Z（内容更新）

- 价格同步（2 处变更）：
- **openrouter**（更新 2）：`deepseek/deepseek-v4-flash`, `deepseek/deepseek-v4-pro`

## 26.73.34 — 2026-09-05T18:46Z（内容更新）

- 价格同步（4 处变更）：
- **openrouter**（更新 4）：`deepseek/deepseek-v4-flash`, `deepseek/deepseek-v4-pro`, `qwen/qwen3.5-35b-a3b`, `tencent/hy3`

## 26.72.34 — 2026-09-05T15:45Z（内容更新）

- 价格同步（3 处变更）：
- **openrouter**（更新 3）：`deepseek/deepseek-v4-flash`, `deepseek/deepseek-v4-pro`, `deepseek/deepseek-v4-pro-0813`

## 26.71.34 — 2026-09-05T12:45Z（内容更新）
...
- 价格同步（4 处变更）：
- **openrouter**（更新 4）：`deepseek/deepseek-v4-flash`, `deepseek/deepseek-v4-pro`, `deepseek/deepseek-v4-pro-0813`, `~deepseek/deepseek-v4-flash-latest`

## 26.64.32 — 2026-09-04T12:46Z（内容更新）

- 价格同步（1 处变更）：
- **openrouter**（更新 1）：`deepseek/deepseek-v4-flash-vision-exp`

## 26.63.32 — 2026-09-04T10:34Z（功能更新）

- 修复CI：仅真实定价变更才推版本号(排除manifest等时间戳)

## 26.63.31 — 2026-09-04T09:42Z（内容更新）

- 本次运行无数据变更。

## 26.62.31 — 2026-09-04T08:17Z（功能更新）

- 数据获取层：新采集路由为主，移除modelsdev旧diff

## 26.62.30 — 2026-09-04T07:32Z（功能更新）

- 数据获取层：接入router+price_check到3h流程

## 26.62.29 — 2026-09-04T07:14Z（内容更新）

- 数据获取层：聚合源(openrouter/models.dev)作为同级provider纳入

## 26.61.29 — 2026-09-04T07:10Z（内容更新）

- 数据获取层：所有采集器迁移为结构化返回

## 26.60.29 — 2026-09-04T07:01Z（内容更新）

- 补记数据获取层骨架重构(阶段1)版本号——此前合并未bump

## 26.59.29 — 2026-09-04T06:43Z（内容更新）

- 本次运行无数据变更。

## 26.58.29 — 2026-09-04T05:29Z（内容更新）

- 数据获取层：采集器移入独立子文件夹

## 26.57.29 — 2026-09-04T03:41Z（内容更新）

- 价格同步（3 处变更）：
- **openrouter**（新增 1）：`x-ai/grok-4.3:batch`
- **openrouter**（更新 2）：`deepseek/deepseek-v4-flash-vision-exp`, `deepseek/deepseek-v4-pro-0813`
