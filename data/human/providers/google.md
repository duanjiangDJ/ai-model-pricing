...
| `gemini-2.0-flash` | ❌ retired | chat | 1.04858M | $0.1 | $0.4 | $0.025 | — | $0.05/$0.2 | — | DEPRECATED and shut down 2026-06-01 (migrate to newer models). Input $0.10 te… |
...
| `gemini-2.5-flash-preview-tts` | — | chat | 8.192K | $0.5 | $10 | — | — | —/— | — | models.dev official list price |
| `gemini-2.5-pro` | — | chat | 1.04858M | $1.25 | $10 | $0.125 | — | $0.625/$5 | — | Two-tier pricing at 200k prompt tokens. <=200k: input $1.25 / output $10.00 /… |
| `gemini-2.5-pro-preview-tts` | — | chat | 8.192K | $1 | $20 | — | — | —/— | — | models.dev official list price |
| `gemini-3-flash-preview` | ❌ retired | chat | 1.04858M | $0.5 | $3 | $0.05 | — | $0.25/$1.5 | — | Preview model. Input $0.50 text/image/video, $1.00 audio; cache $0.05 text/im… |
...
| `gemini-3.1-flash-tts-preview` | — | reasoning | 8.192K | $1 | $20 | — | — | —/— | — | models.dev official list price |
| `gemini-3.1-pro-preview` | 🧪 preview | chat | 1.04858M | $2 | $12 | $0.2 | — | $1/$6 | — | Two-tier pricing at 200k prompt tokens. <=200k: input $2.00 / output $12.00 /… |
...
| `gemini-robotics-er-1.6-preview` | — | reasoning | 131.072K | $1 | $5 | — | — | —/— | — | models.dev official list price |
