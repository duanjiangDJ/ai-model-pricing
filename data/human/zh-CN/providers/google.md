...
| `gemini-2.0-flash` | ❌ 下线 | chat | 1.04858M | $0.1 | $0.4 | $0.025 | — | $0.05/$0.2 | — | DEPRECATED and shut down 2026-06-01 (migrate to newer models). Input $0.10 te… |
...
| `gemini-3-flash-preview` | ❌ 下线 | chat | 1.04858M | $0.5 | $3 | $0.05 | — | $0.25/$1.5 | — | Preview model. Input $0.50 text/image/video, $1.00 audio; cache $0.05 text/im… |
...
| `gemini-3.1-pro-preview` | ✅ 在线 | chat | 1.04858M | $2 | $12 | $0.2 | — | $1/$6 | — | Two-tier pricing at 200k prompt tokens. <=200k: input $2.00 / output $12.00 /… |
