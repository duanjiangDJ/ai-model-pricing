...
|---|---|---|---|---|---|---|---|---|---|---|
| `grok-3` | ❌ 已退役 | chat | — | — | — | — | — | —/— | — | grok-3 retired from xAI API 2026-05-15; redirects to grok-4.3 with 'none' rea… |
| `grok-4` | ❌ 已退役 | chat | — | — | — | — | — | —/— | — | 2025-era Grok 4 family (grok-4-0709, grok-4-fast-reasoning, grok-4-fast-non-r… |
| `grok-4-fast` | ❌ 已退役 | chat | — | — | — | — | — | —/— | — | grok-4-fast-reasoning and grok-4-fast-non-reasoning retired 2026-05-15; redir… |
...
| `grok-4.3` | ❌ 已退役 | chat | 1M | $1.25 | $2.5 | $0.2 | — | $1/$2 | — | Two-tier long-context pricing. <200k: input $1.25 / cached $0.20 / output $2.… |
...
| `grok-build-0.1` | ❌ 已退役 | code | 256K | $1 | $2 | $0.2 | — | —/— | — | Agentic coding model. Two-tier pricing at 200k: <200k input $1.00 / cached $0… |
| `grok-code-fast-1` | ❌ 已退役 | code | — | — | — | — | — | —/— | — | Retired from xAI API 2026-05-15; redirects to grok-build-0.1 (recommended rep… |
