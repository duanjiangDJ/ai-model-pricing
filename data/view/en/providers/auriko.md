...
| `kimi-k2.5` | — | reasoning | per-token | 262.144K | $0.5 | $2.8 | — | — | —/— | — | models.dev official list price |
| `kimi-k2.6` | — | reasoning | per-token | 262.144K | $0.95 | $4 | $0.16 | — | —/— | — | models.dev official list price |
| `minimax-m2-7` | — | reasoning | per-token | 204.8K | $0.3 | $1.2 | — | — | —/— | — | models.dev official list price |
| `minimax-m2-7-highspeed` | — | reasoning | per-token | 204.8K | $0.6 | $2.4 | — | — | —/— | — | models.dev official list price |
