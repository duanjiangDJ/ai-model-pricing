...
| `gemini/gemini-2.5-pro` | ✅ online | reasoning | per-token | 1.04858M | $1.25 | $10 | $0.125 | — | —/— | — | models.dev official list price |
| `gemini/gemini-3-flash-preview` | ✅ online | reasoning | per-token | 1.04858M | $0.5 | $3 | $0.05 | — | —/— | — | models.dev official list price |
...
| `moonshot/kimi-k2.5` | ✅ online | reasoning | per-token | 262K | $0.62 | $3.3 | $0.11 | — | —/— | — | models.dev official list price |
| `moonshot/kimi-k2.6` | ✅ online | reasoning | per-token | 262K | $1 | $4.16 | $0.18 | — | —/— | — | models.dev official list price |
| `moonshot/kimi-k2.7-code` | ✅ online | reasoning | per-token | 262K | $1 | $4.16 | $0.18 | — | —/— | — | models.dev official list price |
...
| `qwen/qwen3.7-flash` | ✅ online | reasoning | per-token | 1M | $0.04 | $0.13 | $0.01 | — | —/— | — | models.dev official list price |
| `qwen/qwen3.7-max` | ✅ online | reasoning | per-token | 1M | $1.88 | $5.63 | $0.375 | — | —/— | — | models.dev official list price |
| `qwen/qwen3.7-plus` | ✅ online | reasoning | per-token | 1M | $0.32 | $1.25 | $0.032 | — | —/— | — | models.dev official list price |
| `qwen/qwen3.8-flash` | ✅ online | reasoning | per-token | 1M | $0.13 | $0.43 | $0.016 | — | —/— | — | models.dev official list price |
| `qwen/qwen3.8-max` | ✅ online | reasoning | per-token | 1M | $1.88 | $5.63 | $0.23 | — | —/— | — | models.dev official list price |
| `tencent/hy3` | ✅ online | reasoning | per-token | 262.144K | $0.16 | $0.64 | $0.04 | — | —/— | — | models.dev official list price |
| `tencent/hy4-preview` | ✅ online | reasoning | per-token | 1.04858M | $0.96 | $2.88 | $0.048 | — | —/— | — | models.dev official list price |
...
| `xiaomi/mimo-v2.5` | ✅ online | reasoning | per-token | 1M | $0.16 | $0.32 | $0.004 | — | —/— | — | models.dev official list price |
| `xiaomi/mimo-v2.5-pro` | ✅ online | reasoning | per-token | 1M | $0.47 | $0.94 | $0.005 | — | —/— | — | models.dev official list price |
| `z-ai/glm-4.7` | ✅ online | reasoning | per-token | 200K | $0.47 | $2.16 | $0.1 | — | —/— | — | models.dev official list price |
| `z-ai/glm-5` | ✅ online | reasoning | per-token | 200K | $0.6 | $3 | $0.16 | — | —/— | — | models.dev official list price |
| `z-ai/glm-5-turbo` | ✅ online | reasoning | per-token | 200K | $0.9 | $3.7 | $0.18 | — | —/— | — | models.dev official list price |
