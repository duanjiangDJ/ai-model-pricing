...
| `anthropic-claude-3.7-sonnet` | ✅ online | reasoning | per-token | 200K | $3 | $15 | $0.3 | — | —/— | — | models.dev official list price |
| `anthropic-claude-4.1-opus` | ✅ online | reasoning | per-token | 200K | $15 | $75 | $1.5 | — | —/— | — | models.dev official list price |
| `anthropic-claude-4.5-haiku` | ✅ online | reasoning | per-token | 200K | $1 | $5 | $1 | — | —/— | — | models.dev official list price |
| `anthropic-claude-4.5-sonnet` | ✅ online | reasoning | per-token | 200K | $3 | $15 | $0.3 | — | —/— | — | models.dev official list price |
| `anthropic-claude-4.6-sonnet` | ✅ online | reasoning | per-token | 200K | $3 | $15 | $0.3 | — | —/— | — | models.dev official list price |
| `anthropic-claude-5-sonnet` | ✅ online | reasoning | per-token | 1M | $2 | $10 | $0.2 | — | —/— | — | models.dev official list price |
...
| `anthropic-claude-opus-4.6` | ✅ online | reasoning | per-token | 200K | $5 | $25 | $0.5 | — | —/— | — | models.dev official list price |
| `anthropic-claude-opus-4.7` | ✅ online | reasoning | per-token | 200K | $5 | $25 | $0.5 | — | —/— | — | models.dev official list price |
...
| `deepseek-r1-distill-llama-70b` | ✅ online | reasoning | per-token | 32.678K | $0.99 | $0.99 | — | — | —/— | — | models.dev official list price |
| `deepseek-v3` | ✅ online | chat | per-token | 163.84K | — | — | — | — | —/— | — | models.dev official list price |
...
| `kimi-k3` | ✅ online | reasoning | per-token | 1.04858M | $2.85 | $14.25 | $0.285 | — | —/— | — | models.dev official list price |
| `llama-4-maverick` | ✅ online | chat | per-token | 128K | $0.2 | $0.696 | — | — | —/— | — | models.dev official list price |
| `llama3-8b-instruct` | ✅ online | chat | per-token | 131.072K | $0.198 | $0.198 | — | — | —/— | — | models.dev official list price |
| `llama3.3-70b-instruct` | ✅ online | chat | per-token | 128K | $0.65 | $0.65 | — | — | —/— | — | models.dev official list price |
| `mimo-v2.5-pro` | ✅ online | reasoning | per-token | 262.144K | $0.4 | $1.5 | $0.08 | — | —/— | — | models.dev official list price |
| `minimax-m2.5` | ✅ online | reasoning | per-token | 65.536K | $0.3 | $1.2 | $0.06 | — | —/— | — | models.dev official list price |
| `ministral-3-8b-instruct-2512` | ✅ online | chat | per-token | 262.144K | — | — | — | — | —/— | — | models.dev official list price |
...
| `nemotron-nano-12b-v2-vl` | ✅ online | reasoning | per-token | 128K | $0.2 | $0.6 | — | — | —/— | — | models.dev official list price |
| `nvidia-nemotron-3-super-120b` | ✅ online | reasoning | per-token | 1M | $0.3 | $0.65 | $0.06 | — | —/— | — | models.dev official list price |
...
| `openai-gpt-4o-mini` | ✅ online | reasoning | per-token | 128K | $0.15 | $0.6 | $0.075 | — | —/— | — | models.dev official list price |
...
| `openai-gpt-5.4` | ✅ online | reasoning | per-token | 400K | $2.5 | $15 | $0.25 | — | —/— | — | models.dev official list price |
