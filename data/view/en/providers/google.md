...
|---|---|---|---|---|---|---|---|---|---|---|---|
| `deep-research-max-preview-04-2026` | ✅ online | reasoning | per-token | 131.072K | $2 | $12 | $0.2 | — | —/— | — | models.dev official list price |
| `deep-research-preview-04-2026` | ✅ online | reasoning | per-token | 131.072K | $2 | $12 | $0.2 | — | —/— | — | models.dev official list price |
...
| `gemini-2.5-flash-preview-tts` | ✅ online | chat | per-token | 8.192K | $0.5 | $10 | — | — | $0.25/$5 | — | Official ai.google.dev/gemini-api/docs/pricing (USD/1M tokens, standard tier;… |
...
| `gemini-2.5-pro-preview-tts` | ✅ online | chat | per-token | 8.192K | $1 | $20 | — | — | $0.5/$10 | — | Official ai.google.dev/gemini-api/docs/pricing (USD/1M tokens, standard tier;… |
...
| `gemini-3.1-flash-tts-preview` | ✅ online | reasoning | per-token | 8.192K | $1 | $20 | — | — | $0.5/$10 | — | Official ai.google.dev/gemini-api/docs/pricing (USD/1M tokens, standard tier;… |
...
| `gemini-3.1-pro-preview-customtools` | ✅ online | reasoning | per-token | 1.04858M | $2 | $12 | $0.2 | — | $1/$6 | — | Official ai.google.dev/gemini-api/docs/pricing (USD/1M tokens, standard tier;… |
...
| `gemini-embedding-001` | ✅ online | embedding | per-token | — | $0.15 | $0 | — | — | $0.075/— | — | Text-only embedding model (gemini-embedding-001). Input billed at $0.15/1M to… |
...
| `gemini-omni-flash-preview` | ✅ online | reasoning | per-token | 131.072K | $1.5 | $17.5 | — | — | —/— | — | models.dev official list price |
