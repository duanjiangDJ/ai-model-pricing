...
|---|---|---|---|---|---|---|---|---|---|---|---|
| `allam-2-7b` | ✅ online | chat | free | 4.096K | $0 | $0 | — | — | —/— | — | models.dev official list price \| Free model (per_mtok = 0). |
| `canopylabs/orpheus-arabic-saudi` | ✅ online | chat | per-token | 4K | — | — | — | — | —/— | — | models.dev official list price |
| `canopylabs/orpheus-v1-english` | ✅ online | chat | per-token | 4K | — | — | — | — | —/— | — | models.dev official list price |
| `groq/compound` | ✅ online | chat | per-token | 131.072K | — | — | — | — | —/— | — | models.dev official list price |
