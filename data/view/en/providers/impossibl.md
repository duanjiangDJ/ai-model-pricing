...
| `cerebras/gpt-oss-120b` | — | reasoning | per-token | 131.072K | $0.35 | $0.75 | — | — | —/— | — | models.dev official list price |
| `deepseek/deepseek-v4-flash` | — | reasoning | per-token | 1M | $0.19 | $0.51 | $0.028 | — | —/— | — | models.dev official list price |
| `deepseek/deepseek-v4-pro` | — | reasoning | per-token | 1M | $1.74 | $3.48 | $0.145 | — | —/— | — | models.dev official list price |
| `fireworks/glm-5.2` | — | reasoning | per-token | 1M | $1.4 | $4.4 | $0.14 | — | —/— | — | models.dev official list price |
| `fireworks/gpt-oss-120b` | — | reasoning | per-token | 131.072K | $0.15 | $0.6 | $0.015 | — | —/— | — | models.dev official list price |
| `fireworks/gpt-oss-20b` | — | reasoning | per-token | 131.072K | $0.07 | $0.3 | $0.035 | — | —/— | — | models.dev official list price |
...
| `groq/gpt-oss-120b` | — | reasoning | per-token | 131.072K | $0.15 | $0.6 | $0.075 | — | —/— | — | models.dev official list price |
| `groq/gpt-oss-20b` | — | reasoning | per-token | 131.072K | $0.075 | $0.3 | $0.0375 | — | —/— | — | models.dev official list price |
...
| `qwen/qwen3.6-flash` | — | reasoning | per-token | 1M | $0.25 | $1.5 | $0.05 | — | —/— | — | models.dev official list price |
...
| `qwen/qwen3.8-max-preview` | — | reasoning | per-token | 1M | $2.5 | $7.5 | — | — | —/— | — | models.dev official list price |
...
| `zai/glm-4.5` | — | reasoning | per-token | 131.072K | $0.6 | $2.2 | $0.11 | — | —/— | — | models.dev official list price |
| `zai/glm-4.5-air` | — | reasoning | per-token | 131.072K | $0.2 | $1.1 | $0.03 | — | —/— | — | models.dev official list price |
| `zai/glm-4.6` | — | reasoning | per-token | 204.8K | $0.6 | $2.2 | $0.11 | — | —/— | — | models.dev official list price |
| `zai/glm-4.7` | — | reasoning | per-token | 204.8K | $0.6 | $2.2 | $0.11 | — | —/— | — | models.dev official list price |
| `zai/glm-5` | — | reasoning | per-token | 204.8K | $1 | $3.2 | $0.2 | — | —/— | — | models.dev official list price |
| `zai/glm-5-turbo` | — | reasoning | per-token | 200K | $1.2 | $4 | $0.24 | — | —/— | — | models.dev official list price |
| `zai/glm-5.1` | — | reasoning | per-token | 200K | $1.4 | $4.4 | $0.26 | — | —/— | — | models.dev official list price |
| `zai/glm-5.2` | — | reasoning | per-token | 1M | $1.4 | $4.4 | $0.26 | — | —/— | — | models.dev official list price |
