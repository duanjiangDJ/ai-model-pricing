...
|---|---|---|---|---|---|---|---|---|---|---|---|
| `MiniMax-M2` | — | reasoning | per-token | 196.608K | $0.3 | $1.2 | $0.03 | $0.375 | —/— | — | Official platform.minimax.io/docs/guides/pricing-paygo (USD per 1M tokens, ef… |
...
| `MiniMax-M3` | — | reasoning | per-token | 1M | $0.3 / ¥2.1 | $1.2 / ¥8.4 | $0.06 | — | —/— | — | models.dev official list price \| MiniMax official CNY (¥/1M tokens): MiniMax… |
