...
|---|---|---|---|---|---|---|---|---|---|---|---|
| `Qwen/Qwen3-30B-A3B-Instruct-2507` | ✅ online | chat | per-token | 262.144K | $0.15 | $0.55 | — | — | —/— | — | models.dev official list price |
| `Qwen/Qwen3-Embedding-0.6B` | ✅ online | embedding | per-token | 40.96K | $0.01 | $0 | — | — | —/— | — | models.dev official list price |
| `Qwen/Qwen3-Reranker-0.6B` | ✅ online | rerank | per-token | 40.96K | $0.01 | $0.01 | — | — | —/— | — | models.dev official list price |
| `Qwen/Qwen3-VL-30B-A3B-Instruct` | ✅ online | chat | per-token | 256K | $0.15 | $0.55 | — | — | —/— | — | models.dev official list price |
| `Qwen/Qwen3.5-122B-A10B` | ✅ online | reasoning | per-token | 131.072K | $0.4 | $3.2 | — | — | —/— | — | models.dev official list price |
| `Qwen/Qwen3.6-35B-A3B-FP8` | ✅ online | reasoning | per-token | 262.144K | $0.17 | $1.1 | $0.056 | — | —/— | — | models.dev official list price |
...
| `anthropic/claude-sonnet-4-5` | ✅ online | reasoning | per-token | 200K | $3 | $15.5 | $0.3 | — | —/— | — | models.dev official list price |
...
| `google/gemini-3-pro` | ✅ online | reasoning | per-token | 1.04858M | $1.25 | $15 | — | — | —/— | — | models.dev official list price |
...
| `google/gemma-4-31B-it` | ✅ online | reasoning | per-token | 262.144K | $0.13 | $0.4 | $0.026 | — | —/— | — | models.dev official list price |
...
| `openai/gpt-5.2` | ✅ online | reasoning | per-token | 400K | $1.8 | $15.5 | $0.18 | — | —/— | — | models.dev official list price |
...
| `openai/gpt-oss-120b` | ✅ online | reasoning | per-token | 131K | $0.15 | $0.55 | — | — | —/— | — | models.dev official list price |
...
| `openai/whisper-large-v3` | ✅ online | chat | per-token | 448 | $0.01 | $0 | — | — | —/— | — | models.dev official list price |
| `zai-org/GLM-5.1-FP8` | ✅ online | reasoning | per-token | 202.752K | $0.85 | $3.3 | — | — | —/— | — | models.dev official list price |
