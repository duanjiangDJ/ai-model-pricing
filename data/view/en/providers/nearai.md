...
| `Qwen/Qwen3-Embedding-0.6B` | — | embedding | per-token | 40.96K | $0.01 | $0 | — | — | —/— | — | models.dev official list price |
...
| `openai/whisper-large-v3` | — | chat | per-token | 448 | $0.01 | $0 | — | — | —/— | — | models.dev official list price |
