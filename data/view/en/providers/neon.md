...
| `gemini-3-1-pro` | — | reasoning | per-token | 1.04858M | $2 | $12 | $0.2 | — | —/— | — | models.dev official list price |
...
| `gemini-3-flash` | — | reasoning | per-token | 1.04858M | $0.5 | $3 | $0.05 | — | —/— | — | models.dev official list price |
| `gemma-3-12b` | — | chat | per-token | 131.072K | $0.15 | $0.5 | — | — | —/— | — | models.dev official list price |
...
| `gpt-oss-20b` | — | reasoning | per-token | 131.072K | $0.07 | $0.3 | — | — | —/— | — | models.dev official list price |
| `inkling` | — | reasoning | per-token | 1.04858M | $1 | $4.05 | $0.17 | — | —/— | — | models.dev official list price |
| `kimi-k3` | — | reasoning | per-token | 1.04858M | $3 | $15 | $0.3 | — | —/— | — | models.dev official list price |
| `llama-4-maverick` | — | chat | per-token | 1M | $0.5 | $1.5 | — | — | —/— | — | models.dev official list price |
| `meta-llama-3-1-8b-instruct` | — | chat | per-token | 131.072K | $0.15 | $0.45 | — | — | —/— | — | models.dev official list price |
| `meta-llama-3-3-70b-instruct` | — | chat | per-token | 128K | $0.5 | $1.5 | — | — | —/— | — | models.dev official list price |
| `qwen3-next-80b-a3b-instruct` | — | chat | per-token | 131.072K | $0.15 | $1.2 | — | — | —/— | — | models.dev official list price |
| `qwen35-122b-a10b` | — | reasoning | per-token | 262.144K | $0.22 | $2.2 | — | — | —/— | — | models.dev official list price |
