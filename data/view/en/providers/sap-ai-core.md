...
| `amazon--titan-embed-text` | — | embedding | per-token | 8.192K | $0.14 | $0 | — | — | —/— | — | models.dev official list price |
...
| `nvidia--llama-3.2-nv-embedqa-1b` | — | embedding | per-token | 8.192K | $0.07 | $0 | — | — | —/— | — | models.dev official list price |
...
| `text-embedding-3-large` | — | embedding | per-token | 8.191K | $0.09 | $0 | — | — | —/— | — | models.dev official list price |
