...
| `gpt-oss-120b` | ✅ online | reasoning | per-token | 128K | $0.15 | $0.6 | — | — | —/— | — | models.dev official list price |
| `llama-3.3-70b-instruct` | ✅ online | chat | per-token | 100K | $0.9 | $0.9 | — | — | —/— | — | models.dev official list price |
| `mistral-medium-3.5-128b` | ✅ online | reasoning | per-token | 256K | $1.5 | $7.5 | — | — | —/— | — | models.dev official list price |
| `mistral-small-3.2-24b-instruct-2506` | ✅ online | chat | per-token | 128K | $0.15 | $0.35 | — | — | —/— | — | models.dev official list price |
| `pixtral-12b-2409` | ✅ online | chat | per-token | 128K | $0.2 | $0.2 | — | — | —/— | — | models.dev official list price |
| `qwen3-235b-a22b-instruct-2507` | ✅ online | reasoning | per-token | 260K | $0.75 | $2.25 | — | — | —/— | — | models.dev official list price |
| `qwen3-coder-30b-a3b-instruct` | ✅ online | chat | per-token | 128K | $0.2 | $0.8 | — | — | —/— | — | models.dev official list price |
