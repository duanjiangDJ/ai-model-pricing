...
- 币种: USD
- 数据更新时间: 2026-08-22T11:41:20Z
- 核实时间: 2026-08-22T11:41:20Z

共 **54** 个模型。

| 模型 | 状态 | 类别 | 上下文 | 输入 $/MTok | 输出 $/MTok | 缓存读 | 缓存写 | 批处理(入/出) | 其他计费 | 备注 |
|---|---|---|---|---|---|---|---|---|---|---|
| `deepseek-v4-flash-0731` | — | reasoning | 1M | $0.2 | $0.4 | $0.04 | — | —/— | — | models.dev official list price |
| `glm-5.2` | — | reasoning | 1M | $1.4 | $4.4 | $0.28 | — | —/— | — | models.dev official list price |
| `qvq-max` | — | reasoning | 131.072K | $1.2 | $4.8 | — | — | —/— | — | models.dev official list price |
| `qwen-flash` | — | reasoning | 1M | $0.05 | $0.4 | — | — | —/— | — | models.dev official list price |
| `qwen-max` | — | chat | 32.768K | $1.6 | $6.4 | — | — | —/— | — | models.dev official list price |
| `qwen-mt-plus` | — | chat | 16.384K | $2.46 | $7.37 | — | — | —/— | — | models.dev official list price |
| `qwen-mt-turbo` | — | chat | 16.384K | $0.16 | $0.49 | — | — | —/— | — | models.dev official list price |
| `qwen-omni-turbo` | — | chat | 32.768K | $0.07 | $0.27 | — | — | —/— | — | models.dev official list price |
| `qwen-omni-turbo-realtime` | — | chat | 32.768K | $0.27 | $1.07 | — | — | —/— | — | models.dev official list price |
| `qwen-plus` | — | reasoning | 1M | $0.4 | $1.2 | — | — | —/— | — | models.dev official list price |
...
| `qwen2-5-72b-instruct` | — | chat | 131.072K | $1.4 | $5.6 | — | — | —/— | — | models.dev official list price |
| `qwen2-5-7b-instruct` | — | chat | 131.072K | $0.175 | $0.7 | — | — | —/— | — | models.dev official list price |
| `qwen2-5-omni-7b` | — | chat | 32.768K | $0.1 | $0.4 | — | — | —/— | — | models.dev official list price |
| `qwen2-5-vl-72b-instruct` | — | chat | 131.072K | $2.8 | $8.4 | — | — | —/— | — | models.dev official list price |
...
| `qwen3-coder-480b-a35b-instruct` | — | chat | 262.144K | $1.5 | $7.5 | — | — | —/— | — | models.dev official list price |
| `qwen3-coder-flash` | — | chat | 1M | $0.3 | $1.5 | — | — | —/— | — | models.dev official list price |
...
| `qwen3-vl-30b-a3b` | — | reasoning | 131.072K | $0.2 | $0.8 | — | — | —/— | — | models.dev official list price |
| `qwen3-vl-plus` | — | reasoning | 262.144K | $0.2 | $1.6 | — | — | —/— | — | models.dev official list price |
| `qwen3.5-122b-a10b` | — | reasoning | 262.144K | $0.4 | $3.2 | — | — | —/— | — | models.dev official list price |
| `qwen3.5-27b` | — | reasoning | 262.144K | $0.3 | $2.4 | — | — | —/— | — | models.dev official list price |
| `qwen3.5-35b-a3b` | — | reasoning | 262.144K | $0.25 | $2 | — | — | —/— | — | models.dev official list price |
