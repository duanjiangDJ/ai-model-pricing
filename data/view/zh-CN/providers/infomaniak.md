...
| `mistralai/Mistral-Small-4-119B-2603` | — | reasoning | 按量 | 256K | $0.25 | $0.93 | — | — | —/— | — | models.dev official list price |
| `moonshotai/Kimi-K2.6` | — | reasoning | 按量 | 256K | $0.74 | $3.72 | — | — | —/— | — | models.dev official list price |
| `nvidia/NVIDIA-Nemotron-3-Nano-30B-A3B-FP8` | — | reasoning | 按量 | 1M | $0.06 | $0.25 | — | — | —/— | — | models.dev official list price |
| `swiss-ai/Apertus-v1.5-70B` | — | chat | 按量 | 100K | $0.87 | $3.1 | — | — | —/— | — | models.dev official list price |
