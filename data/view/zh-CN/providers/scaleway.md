...
| `gpt-oss-120b` | ✅ 在线 | reasoning | 按量 | 128K | $0.15 | $0.6 | — | — | —/— | — | models.dev official list price |
| `llama-3.3-70b-instruct` | ✅ 在线 | chat | 按量 | 100K | $0.9 | $0.9 | — | — | —/— | — | models.dev official list price |
| `mistral-medium-3.5-128b` | ✅ 在线 | reasoning | 按量 | 256K | $1.5 | $7.5 | — | — | —/— | — | models.dev official list price |
| `mistral-small-3.2-24b-instruct-2506` | ✅ 在线 | chat | 按量 | 128K | $0.15 | $0.35 | — | — | —/— | — | models.dev official list price |
| `pixtral-12b-2409` | ✅ 在线 | chat | 按量 | 128K | $0.2 | $0.2 | — | — | —/— | — | models.dev official list price |
| `qwen3-235b-a22b-instruct-2507` | ✅ 在线 | reasoning | 按量 | 260K | $0.75 | $2.25 | — | — | —/— | — | models.dev official list price |
| `qwen3-coder-30b-a3b-instruct` | ✅ 在线 | chat | 按量 | 128K | $0.2 | $0.8 | — | — | —/— | — | models.dev official list price |
