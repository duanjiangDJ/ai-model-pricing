...
|---|---|---|---|---|---|---|---|---|---|---|
| `glm-5.3-flash` | — | reasoning | 1M | — | — | — | — | —/— | ⚡ 峰谷双档 | Included in GLM Coding Plan (credits-based). Credit multipliers: input 2.3, c… |
| `glm-5.3` | — | reasoning | 1M | — | — | — | — | —/— | ⚡ 峰谷双档 | Included in GLM Coding Plan (credits-based). Credit multipliers: input 6.9, c… |
