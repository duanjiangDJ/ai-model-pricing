"""abliteration.ai official pricing check (tier 1, auto-generated collection template).

Official pricing page: https://docs.abliteration.ai/models
...
URL = 'https://docs.abliteration.ai/models'
