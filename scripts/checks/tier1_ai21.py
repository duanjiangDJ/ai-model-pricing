"""ai21 official pricing check (tier 1). Best-effort fetch; on failure records that the data was manually reconciled (2026-08-28) so the check does not silently mis-update. Parser can be added once reliably fetchable."""
import sys
...
TIER = 1
PROVIDER_ID = "ai21"
URL = "https://studio.ai21.com/pricing"
