"""AI-ROUTER official pricing check (tier 1, auto-generated collection template).

Official pricing page: https://ai-router.dev/openai-compatible-api-gateway/
...
URL = 'https://ai-router.dev/openai-compatible-api-gateway/'
