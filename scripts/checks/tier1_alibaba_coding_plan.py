"""Alibaba Coding Plan official pricing check (tier 1, auto-generated collection template).

Official pricing page: https://www.alibabacloud.com/help/en/model-studio/coding-plan
