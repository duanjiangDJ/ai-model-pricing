"""Alibaba Coding Plan (China) official pricing check (tier 1, auto-generated collection template).

Official pricing page: https://help.aliyun.com/zh/model-studio/coding-plan
