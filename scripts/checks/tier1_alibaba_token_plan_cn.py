"""Alibaba Token Plan (China) official pricing check (tier 1, auto-generated collection template).

Official pricing page: https://www.alibabacloud.com/help/zh/model-studio/token-plan-overview
...
URL = 'https://www.alibabacloud.com/help/zh/model-studio/token-plan-overview'
