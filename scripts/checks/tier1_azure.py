"""Azure official pricing check (tier 1, auto-generated collection template).

Official pricing page: https://learn.microsoft.com/en-us/azure/ai-services/openai/concepts/models
