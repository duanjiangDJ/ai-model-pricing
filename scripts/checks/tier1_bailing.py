"""Bailing official pricing check (tier 1, auto-generated collection template).

Official pricing page: https://alipaytbox.yuque.com/sxs0ba/ling/intro
...
TIER = 1
PROVIDER_ID = "bailing"
URL = 'https://alipaytbox.yuque.com/sxs0ba/ling/intro'
