"""Clarifai official pricing check (tier 1, auto-generated collection template).

Official pricing page: https://docs.clarifai.com/compute/inference/
...
URL = 'https://docs.clarifai.com/compute/inference/'
