"""CloudFerro Sherlock official pricing check (tier 1, auto-generated collection template).

Official pricing page: https://docs.sherlock.cloudferro.com/
...
URL = 'https://docs.sherlock.cloudferro.com/'
