"""Cloudflare Workers AI official pricing check (tier 1, auto-generated collection template).

Official pricing page: https://developers.cloudflare.com/workers-ai/models/
