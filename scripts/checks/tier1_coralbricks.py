"""CoralBricks official pricing check (tier 1, auto-generated collection template).

Official pricing page: https://www.coralbricks.ai/docs
...
URL = 'https://www.coralbricks.ai/docs'
