"""CrossModel official pricing check (tier 1, auto-generated collection template).

Official pricing page: https://www.crossmodel.ai/docs
...
URL = 'https://www.crossmodel.ai/docs'
