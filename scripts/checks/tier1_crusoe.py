"""Crusoe official pricing check (tier 1, auto-generated collection template).

Official pricing page: https://docs.crusoecloud.com/managed-inference/overview
...
TIER = 1
PROVIDER_ID = "crusoe"
URL = 'https://docs.crusoecloud.com/managed-inference/overview'
