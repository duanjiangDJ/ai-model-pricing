"""Databricks official pricing check (tier 1, auto-generated collection template).

Official pricing page: https://docs.databricks.com/aws/en/machine-learning/foundation-models/
...
URL = 'https://docs.databricks.com/aws/en/machine-learning/foundation-models/'
