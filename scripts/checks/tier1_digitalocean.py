"""DigitalOcean official pricing check (tier 1, auto-generated collection template).

Official pricing page: https://docs.digitalocean.com/products/gradient-ai-platform/details/models/
