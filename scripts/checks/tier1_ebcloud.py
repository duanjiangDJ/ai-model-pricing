"""EBCloud official pricing check (tier 1, auto-generated collection template).

Official pricing page: https://docs.ebtech.com/ai/model-api.html
...
TIER = 1
PROVIDER_ID = "ebcloud"
URL = 'https://docs.ebtech.com/ai/model-api.html'
