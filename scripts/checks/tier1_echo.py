"""Echo official pricing check (tier 1, auto-generated collection template).

Official pricing page: https://echo.tracerml.ai/docs/api
...
TIER = 1
PROVIDER_ID = "echo"
URL = 'https://echo.tracerml.ai/docs/api'
