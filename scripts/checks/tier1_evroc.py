"""evroc official pricing check (tier 1, auto-generated collection template).

Official pricing page: https://docs.evroc.com/products/think/overview.html
...
TIER = 1
PROVIDER_ID = "evroc"
URL = 'https://docs.evroc.com/products/think/overview.html'
