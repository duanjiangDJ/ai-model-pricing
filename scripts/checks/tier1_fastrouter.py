"""FastRouter official pricing check (tier 1, auto-generated collection template).

Official pricing page: https://fastrouter.ai/models
...
URL = 'https://fastrouter.ai/models'
