"""Friendli official pricing check (tier 1, auto-generated collection template).

Official pricing page: https://friendli.ai/docs/guides/serverless_endpoints/introduction
...
URL = 'https://friendli.ai/docs/guides/serverless_endpoints/introduction'
