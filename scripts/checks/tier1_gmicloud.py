"""GMI Cloud official pricing check (tier 1, auto-generated collection template).

Official pricing page: https://docs.gmicloud.ai/inference-engine/api-reference/llm-api-reference
...
URL = 'https://docs.gmicloud.ai/inference-engine/api-reference/llm-api-reference'
