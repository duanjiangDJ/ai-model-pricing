"""Vertex official pricing check (tier 1, auto-generated collection template).

Official pricing page: https://cloud.google.com/vertex-ai/generative-ai/docs/models
