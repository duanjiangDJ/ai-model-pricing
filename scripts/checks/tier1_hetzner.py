"""Hetzner official pricing check (tier 1, auto-generated collection template).

Official pricing page: https://experiments.hetzner.com/docs/inference
...
TIER = 1
PROVIDER_ID = "hetzner"
URL = 'https://experiments.hetzner.com/docs/inference'
