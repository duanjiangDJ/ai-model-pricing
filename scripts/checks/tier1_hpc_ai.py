"""HPC-AI official pricing check (tier 1, auto-generated collection template).

Official pricing page: https://www.hpc-ai.com/doc/docs/quickstart/
...
TIER = 1
PROVIDER_ID = "hpc-ai"
URL = 'https://www.hpc-ai.com/doc/docs/quickstart/'
