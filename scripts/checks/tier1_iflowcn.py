"""iFlow official pricing check (tier 1, auto-generated collection template).

Official pricing page: https://platform.iflow.cn/en/docs
...
TIER = 1
PROVIDER_ID = "iflowcn"
URL = 'https://platform.iflow.cn/en/docs'
