"""Impossibl official pricing check (tier 1, auto-generated collection template).

Official pricing page: https://impossibl.com/docs/models
...
URL = 'https://impossibl.com/docs/models'
