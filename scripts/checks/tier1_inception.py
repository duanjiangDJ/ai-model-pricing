"""Inception official pricing check (tier 1, auto-generated collection template).

Official pricing page: https://platform.inceptionlabs.ai/docs
...
URL = 'https://platform.inceptionlabs.ai/docs'
