"""Inference official pricing check (tier 1, auto-generated collection template).

Official pricing page: https://inference.net/models
...
URL = 'https://inference.net/models'
