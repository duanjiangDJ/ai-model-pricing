"""InferX official pricing check (tier 1, auto-generated collection template).

Official pricing page: https://model.inferx.net/endpoints
...
TIER = 1
PROVIDER_ID = "inferx"
URL = 'https://model.inferx.net/endpoints'
