"""Infomaniak official pricing check (tier 1, auto-generated collection template).

Official pricing page: https://www.infomaniak.com/en/hosting/ai-services/open-source-models
...
URL = 'https://www.infomaniak.com/en/hosting/ai-services/open-source-models'
