"""IO.NET official pricing check (tier 1, auto-generated collection template).

Official pricing page: https://io.net/docs/guides/intelligence/io-intelligence
...
TIER = 1
PROVIDER_ID = "io-net"
URL = 'https://io.net/docs/guides/intelligence/io-intelligence'
