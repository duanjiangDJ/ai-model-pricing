"""Jalapeno Cloud official pricing check (tier 1, auto-generated collection template).

Official pricing page: https://www.jalapeno-cloud.ai/docs/
...
URL = 'https://www.jalapeno-cloud.ai/docs/'
