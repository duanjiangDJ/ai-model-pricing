"""Kosmik Compute official pricing check (tier 1, auto-generated collection template).

Official pricing page: https://api.koscompute.com/docs/
...
TIER = 1
PROVIDER_ID = "kosmik"
URL = 'https://api.koscompute.com/docs/'
