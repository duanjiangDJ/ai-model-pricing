"""Lilac official pricing check (tier 1, auto-generated collection template).

Official pricing page: https://docs.getlilac.com/inference/models
...
TIER = 1
PROVIDER_ID = "lilac"
URL = 'https://docs.getlilac.com/inference/models'
