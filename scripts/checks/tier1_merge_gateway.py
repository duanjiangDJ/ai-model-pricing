"""Merge Gateway official pricing check (tier 1, auto-generated collection template).

Official pricing page: https://docs.merge.dev/merge-gateway
...
URL = 'https://docs.merge.dev/merge-gateway'
