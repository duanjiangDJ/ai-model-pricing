"""Modelis official pricing check (tier 1, auto-generated collection template).

Official pricing page: https://modelishub.com/pricing
...
TIER = 1
PROVIDER_ID = "modelis"
URL = 'https://modelishub.com/pricing'
