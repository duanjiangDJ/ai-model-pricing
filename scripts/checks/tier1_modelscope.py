"""ModelScope official pricing check (tier 1, auto-generated collection template).

Official pricing page: https://modelscope.cn/docs/model-service/API-Inference/intro
