"""Morph official pricing check (tier 1, auto-generated collection template).

Official pricing page: https://docs.morphllm.com/api-reference/introduction
...
TIER = 1
PROVIDER_ID = "morph"
URL = 'https://docs.morphllm.com/api-reference/introduction'
