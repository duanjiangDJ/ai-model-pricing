"""Neuralwatt official pricing check (tier 1, auto-generated collection template).

Official pricing page: https://portal.neuralwatt.com/docs
...
URL = 'https://portal.neuralwatt.com/docs'
