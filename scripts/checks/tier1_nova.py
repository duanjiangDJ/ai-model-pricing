"""Nova official pricing check (tier 1, auto-generated collection template).

Official pricing page: https://nova.amazon.com/dev/documentation
...
TIER = 1
PROVIDER_ID = "nova"
URL = 'https://nova.amazon.com/dev/documentation'
