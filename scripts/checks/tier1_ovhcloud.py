"""OVHcloud AI Endpoints official pricing check (tier 1, auto-generated collection template).

Official pricing page: https://www.ovhcloud.com/en/public-cloud/ai-endpoints/catalog//
