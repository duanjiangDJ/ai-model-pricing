"""Pioneer official pricing check (tier 1, auto-generated collection template).

Official pricing page: https://agent.pioneer.ai/llms.txt
...
TIER = 1
PROVIDER_ID = "pioneer"
URL = 'https://agent.pioneer.ai/llms.txt'
