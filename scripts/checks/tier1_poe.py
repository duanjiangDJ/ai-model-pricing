"""Poe official pricing check (tier 1, auto-generated collection template).

Official pricing page: https://creator.poe.com/docs/external-applications/openai-compatible-api
