"""Privatemode AI official pricing check (tier 1, auto-generated collection template).

Official pricing page: https://docs.privatemode.ai/api/overview
...
URL = 'https://docs.privatemode.ai/api/overview'
