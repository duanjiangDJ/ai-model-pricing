"""Requesty official pricing check (tier 1, auto-generated collection template).

Official pricing page: https://requesty.ai/solution/llm-routing/models
...
URL = 'https://requesty.ai/solution/llm-routing/models'
