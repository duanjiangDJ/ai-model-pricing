"""SaladCloud AI Gateway official pricing check (tier 1, auto-generated collection template).

Official pricing page: https://docs.salad.com/ai-gateway/explanation/overview
...
URL = 'https://docs.salad.com/ai-gateway/explanation/overview'
