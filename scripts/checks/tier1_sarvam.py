"""Sarvam AI official pricing check (tier 1, auto-generated collection template).

Official pricing page: https://docs.sarvam.ai/api-reference-docs/getting-started/models
...
TIER = 1
PROVIDER_ID = "sarvam"
URL = 'https://docs.sarvam.ai/api-reference-docs/getting-started/models'
