"""StepFun Step Plan (Global) official pricing check (tier 1, auto-generated collection template).

Official pricing page: https://platform.stepfun.ai/docs/en/step-plan/integrations/reasoning-api
...
URL = 'https://platform.stepfun.ai/docs/en/step-plan/integrations/reasoning-api'
