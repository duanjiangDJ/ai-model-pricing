"""StepFun Step Plan (China) official pricing check (tier 1, auto-generated collection template).

Official pricing page: https://platform.stepfun.com/docs/zh/step-plan/integrations/reasoning-api
