"""Subconscious official pricing check (tier 1, auto-generated collection template).

Official pricing page: https://docs.subconscious.dev
...
URL = 'https://docs.subconscious.dev'
