"""Synthetic official pricing check (tier 1, auto-generated collection template).

Official pricing page: https://synthetic.new/pricing
...
URL = 'https://synthetic.new/pricing'
