"""Thinking Machines official pricing check (tier 1, auto-generated collection template).

Official pricing page: https://tinker-docs.thinkingmachines.ai/tinker/compatible-apis/anthropic/
...
URL = 'https://tinker-docs.thinkingmachines.ai/tinker/compatible-apis/anthropic/'
