"""TrustedRouter official pricing check (tier 1, auto-generated collection template).

Official pricing page: https://trustedrouter.com/docs
...
URL = 'https://trustedrouter.com/docs'
