"""v0 official pricing check (tier 1, auto-generated collection template).

Official pricing page: https://sdk.vercel.ai/providers/ai-sdk-providers/vercel
...
TIER = 1
PROVIDER_ID = "v0"
URL = 'https://sdk.vercel.ai/providers/ai-sdk-providers/vercel'
