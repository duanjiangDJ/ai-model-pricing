"""Vivgrid official pricing check (tier 1, auto-generated collection template).

Official pricing page: https://docs.vivgrid.com/models
...
TIER = 1
PROVIDER_ID = "vivgrid"
URL = 'https://docs.vivgrid.com/models'
