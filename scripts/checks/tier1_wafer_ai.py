"""Wafer official pricing check (tier 1, auto-generated collection template).

Official pricing page: https://docs.wafer.ai/wafer-pass
...
URL = 'https://docs.wafer.ai/wafer-pass'
