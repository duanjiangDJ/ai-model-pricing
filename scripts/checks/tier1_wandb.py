"""Weights & Biases official pricing check (tier 1, auto-generated collection template).

Official pricing page: https://docs.wandb.ai/guides/integrations/inference/
...
TIER = 1
PROVIDER_ID = "wandb"
URL = 'https://docs.wandb.ai/guides/integrations/inference/'
