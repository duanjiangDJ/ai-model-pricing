"""watsonx.ai official pricing check (tier 1, auto-generated collection template).

Official pricing page: https://www.ibm.com/docs/en/watsonx/saas?topic=solutions-supported-foundation-models
