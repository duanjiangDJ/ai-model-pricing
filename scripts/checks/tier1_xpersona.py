"""Xpersona official pricing check (tier 1, auto-generated collection template).

Official pricing page: https://www.xpersona.co/docs
...
URL = 'https://www.xpersona.co/docs'
